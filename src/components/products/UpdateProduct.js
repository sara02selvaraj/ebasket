...
import {updateFormInput} from "../../redux/bigbasket/bigbasket.actions";
...
let UpdateProduct = () => {
    ...
    let {loading , errorMessage , product} = selectedProductInfo;

    let [submitted , setSubmitted] = useState(false);

    useEffect(() => {
        dispatch(bigBasketActions.getProduct(productId));
    }, [productId]);
    ...
    let submitProduct = (event) => {
        ...
        dispatch(bigBasketActions.updateProduct(productId , product , history));
    };
